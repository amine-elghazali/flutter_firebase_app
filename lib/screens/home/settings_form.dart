...
class _SettingsFormState extends State<SettingsForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UserData>(
      ...
      builder: (context, snapshot) {  // this snapshot refers to the data coming back from the stream 
        if(snapshot.hasData){
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                validator: (val) => val!.isEmpty ? 'Enter a name please ' : null,
              ...
              Slider(
                ...
                onChanged: (val)=> setState(() => _currentStrength = val.round() ) // round the value to the nearest integer
              ),
              SizedBox(height: 10.0,),
                  ElevatedButton(
